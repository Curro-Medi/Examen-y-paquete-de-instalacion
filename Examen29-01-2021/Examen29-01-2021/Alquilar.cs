...
namespace Examen29_01_2021
{
    public partial class Alquilar : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach(Cliente c in Losclientes)
            {
                if(c == ListaClientes.SelectedItem)
                {
                    ...
                    Videojuego vid = (Videojuego)ListaVideojuegos.SelectedItem;

                    c.videojuegos.Add(vid);
                }
            }
        ...
        private void ListaVideojuegos_SelectedIndexChanged(object sender, EventArgs e)
        {
